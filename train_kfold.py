...
# test_cross_data = [d for d in data_info if d['type'] == 'test_cross']
#
# num_test_cross_samples = int(0.2 * len(test_cross_data))
# selected_test_cross_data = random.choices(test_cross_data, k=num_test_cross_samples)
# train_data = temp_train_data + selected_test_cross_data
...
scheduler = optim.lr_scheduler.LinearLR(optimizer, start_factor=0.7, end_factor=0.001, total_iters=epochs*5)
...
# Save model
model_file = 'models/eegnet_5fold_train6.pth'
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('images_train11_kfold/train_losses_5fold.png')
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('images_train11_kfold/train_losses_5fold_fold1.png')
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('images_train11_kfold/train_losses_5fold_fold2.png')
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('images_train11_kfold/train_losses_5fold_fold3.png')
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('images_train11_kfold/train_losses_5fold_fold4.png')
plt.close()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('images_train11_kfold/train_losses_5fold_fold5.png')
plt.close()
