...
file_path = 'model-data/train/sub-001_eeg_chunk_1.set'
raw = mne.io.read_raw_eeglab(file_path)
data = raw.get_data().astype('float32')
data = data.reshape(1, 19, 1425)
# Convert to tensor
...
model.visualize_temporal_filters(data, 'images/eegnet_temporal_filters')
...
# Shape (conv1): torch.Size([1, 5, 19, 1426])
# Shape (batchnorm1): torch.Size([1, 5, 19, 1426])
# Shape (depthwise_conv1): torch.Size([1, 25, 1, 1426])
# Shape (batchnorm2): torch.Size([1, 25, 1, 1426])
# Shape (activation1): torch.Size([1, 25, 1, 1426])
# Shape (avgpool1): torch.Size([1, 25, 1, 356])
# Shape (dropout1): torch.Size([1, 25, 1, 356])
# Shape (separable_conv2): torch.Size([1, 25, 1, 357])
# Shape (batchnorm3): torch.Size([1, 25, 1, 357])
# Shape (activation2): torch.Size([1, 25, 1, 357])
# Shape (avgpool2): torch.Size([1, 25, 1, 44])
# Shape (dropout2): torch.Size([1, 25, 1, 44])
# Shape (flatten): torch.Size([1, 1100])
